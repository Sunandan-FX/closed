    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('athlete', 'Athlete'), ('coach', 'Coach'), ('medical', 'Medical Staff')], default='athlete', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fitness_level', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High')], default='medium', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('license_no', models.CharField(blank=True, max_length=100, unique=True)),
